...
//	public final CommonEventHandler commonEventHandler = new CommonEventHandler();
	...
	@Override//needs to be public for mod to work
	public void onInitialize() {
		addReloadEvent(registryLoader);
...
//	}
	...
	public void addReloadEvent(RegistryLoader registryLoader) {
		ResourceManagerHelper.get(ResourceType.SERVER_DATA).registerReloadListener(registryLoader);
	}
}
